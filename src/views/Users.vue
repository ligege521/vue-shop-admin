   ...
   export default {
      ...
      methods: {
         ...
         async svaeRoleInfo () {
            ...
            const {data: res} = await this.$http.put(`users/${this.roleUserinfo.id}/role`, {
               rid: this.selectedRoleId
            });
            console.log(res, this.roleUserinfo.id, this.selectedRoleId)
            if (res.meta.status !== 200) {
               if (res.meta.msg && res.meta.msg !== '') {
