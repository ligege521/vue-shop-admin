        ...
        <el-card>
            <el-row :gutter="20">
                <el-col :span="8">
                    <el-input placeholder="请输入内容" 
                        class="input-with-select" v-model="queryInfo.query"
                        clearable @change="getGoodsList"
                    >
            ...
            <el-table :data="goodsList" border stripe>
                ...
                <el-table-column label="商品重量"
                    prop="goods_weight"  width="70px"
                ></el-table-column>
                <el-table-column label="创建时间" 
                    prop="add_time"  width="180px"
                >
   ...
   export default {
       ...
       methods: {
           // 根据分页获取商品列表
            ...
            // 删除商品
            async removeById (id) {
                let confirmResult = await this.$confirm('此操作将删除商品, 是否继续?', '提示', {
